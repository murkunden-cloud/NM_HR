...
echo.
echo Starting PZHR Web Main Server in Production (Port 3001)...
...
echo Ensure port 3001 and 4002 are open in the Windows Firewall for Intranet access.
echo You can access it on this PC at: http://localhost:3001
echo Others can access it via http://YOUR-IP-ADDRESS:3001 or http://hr.punezone.com (if DNS is configured)
echo ========================================================
pause

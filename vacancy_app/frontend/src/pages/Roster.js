...
import { SANCTION_III as initialSanctionIII, SANCTION_IV as initialSanctionIV, FILLED_III_MASTER as initialFilledIII, FILLED_IV_MASTER as initialFilledIV, SURPLUS_III as initialSurplusIII, SURPLUS_IV as initialSurplusIV } from "./RosterData";
...
export default function App(){
  ...
  // Integrated mode — navigate to main app dashboard
  ...
  // Set up periodic auto-refresh check (disabled in integrated mode)
  useEffect(() => {
        ...
        <div style={{maxWidth:1700,margin:"0 auto"}}>
          <div style={{padding:"14px 0 0",display:"flex",alignItems:"center",gap:12,flexWrap:"wrap"}}>
            ...
            <div style={{display:"flex",gap:8,alignItems:"center",flexWrap:"wrap"}}>
              ...
              <button onClick={handleExit} style={{padding:"7px 16px",background:"rgba(239,68,68,0.85)",border:"1px solid rgba(255,100,100,0.5)",borderRadius:7,color:"#fff",cursor:"pointer",fontSize:13,fontWeight:700,boxShadow:"0 2px 8px rgba(239,68,68,0.4)",marginLeft:4}}>
                🏠 Main App
              </button>
            </div>
          </div>
